...
export const APP_FEATURES_REGISTRY = [
  ...
  feature({
    ...
    description: 'Canvas 픽셀 슬라이싱, 고대비 절단선, 360×360 샤프닝/대비 보정, JSZip 카카오 규격 점검',
    ...
    guideContent: {
      ...
      play: [
        ...
        },
        {
          ...
          body: '상단 [🧩 이모티콘 시트 분할기]에서 시트를 올립니다. 모드 A는 객체를 자동으로 찾고, 모드 B는 열/행 슬라이더로 균등 선을 깐 뒤 미리보기에서 시안/마젠타 네온 실선 절단선을 드래그해 칸을 맞춥니다. 분할 시 360×360으로 리사이즈하면서 고품질 보간·가벼운 샤프닝·대비 +8%로 글자와 외곽선을 또렷하게 보정합니다. [📦 전체 ZIP 다운로드 (카카오 규격 360x360)]로 받습니다.',
          params: ['고대비 시안/마젠타 절단선', '드래그 핸들 핀', '360×360 샤프닝', '투명 배경 · ZIP'],
          tip: '절단선 가운데 네모 핀을 잡고 옮기면 맞추기 쉽습니다. 슬라이더를 다시 움직이면 그 축은 균등 분할로 돌아갑니다.',
