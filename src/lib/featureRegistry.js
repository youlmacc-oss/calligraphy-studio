      ...
      play: [
        {
          ...
          body: '중앙 툴바와 우측 패널의 [🎬 모션 GIF 스튜디오]를 누르면 독립 3단 스튜디오가 열리고, 현재 메인 캔버스 스냅샷이 소스로 들어갑니다. 좌측에서 로컬 PNG/JPG를 올릴 수 있고, 우측에서 5대 프리셋·루프·강도·FPS·규격을 고릅니다. GIF 인코더 연결은 다음 단계입니다. 기존 3프리셋 칩은 스튜디오 프리셋과 별개로 남아 있습니다.',
