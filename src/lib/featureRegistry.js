...
export const APP_FEATURES_REGISTRY = [
  ...
  feature({
    ...
    description: '분할기 사이드 280~600px 드래그 리사이저 · 메인/서브 레이어 독립 State',
  ...
  feature({
    ...
    description: '모드 A CCA 스마트 감지 원형 보존 · 후처리만 비침습 적용 · 타이포 연산',
  ...
  feature({
    ...
    description: '시트 업로드 즉시 줌 35% → 모드 A → 모드 B 가이드 세팅 · 크롭/필터',
  ...
  feature({
    ...
    description: '와이드 95vw×92vh · 개발 뷰 1600 스케일 · 모션 없음 기본 · 내 PC 업로드 클릭/드롭 · 인코딩 진행률 · 단일 이미지 RAF 루프 · 파티클 4종 · 핑퐁 루프 · 채팅 시뮬 · 심사 스펙 HUD · 클립 저장 · 360 GIF/WebP · ZIP motion-01 · checkerboard-bg · bg-white 금지',
