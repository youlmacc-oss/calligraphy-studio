    ...
    guideContent: {
      ...
      play: [
        ...
        },
        {
          ...
          body: 'GIF/WebP 내보내기를 누르면 중앙에 진행률 팝업이 뜨고, 프레임마다 메인 스레드를 양보해 화면이 멈추지 않습니다. 인코더는 초고화질 무한루프와 같은 정제 버퍼만 받아 가짜 체커보드 사각이 배경 위에 남지 않습니다. 끝나면 OS 폴더 선택 창으로 저장되고(미지원 시 기본 다운로드) 임시 렌더 큐는 비워져 클립 라인에 복제본이 남지 않습니다. 마음에 들면 [클립 저장]으로 보관함 슬롯을 쌓고, 각 카드 [❌]로 개별 삭제하거나 [전체 비우기]로 초기화합니다. 작업 중이던 클립을 지우면 시퀀서는 기본 상태로 돌아갑니다.',
