...
export const APP_FEATURES_REGISTRY = [
  ...
  feature({
    ...
    guideContent: {
      ...
      sample: GUIDE_SAMPLES['pungjeong-kitsch'],
      kicker: '첫 화면 기본은 龍 Dragon 풍정 + 키치 스티커 콜라주입니다. 배민 잘난체, 크림 채움, 갈색 외곽, F&B 스티커를 켜 둔 상태입니다.',
      visuals: [
      ...
      summary: [
        ...
        { title: '프리셋 원클릭', body: '첨부하신 크림 글자+별/고추/머그 장식은 [🎨 19종 올인원]에서 [키치 스티커 콜라주]를 고르고, 카드 아래 [스티커 켜기]와 [F&B / 카페]를 켠 결과입니다. 툴바 [기본 키치]나 이 장의 샘플 버튼으로 같은 룩을 다시 불러옵니다. 다른 프리셋은 올인원·캘리·목각 탭 카드를 누르면 그 레이어만 바뀝니다.' },
      ...
      play: [
        {
          ...
          body: '첫 실행 기본 샘플은 龍 Dragon 풍정 · 키치 스티커 콜라주(배민 잘난체 70px, 스티커 ON, F&B)입니다. 왼쪽에서 👑 메인 또는 ✨ 서브 카드를 누르거나 캔버스 글자를 클릭하면 청록(메인) 또는 핑크(서브) 점선 상자가 글자·외곽선·스티커까지 감쌉니다. 상자는 캔버스 실측 뒤에 그리고, 격자는 미리보기 플레이트 위에 그립니다.',
