      ...
      play: [
        {
          ...
          body: '첫 실행 기본 샘플은 龍 Dragon 풍정 · 훈민정음 언해본 목각 39px입니다. 왼쪽에서 👑 메인 또는 ✨ 서브 카드를 누르거나 캔버스 글자를 클릭하면 청록(메인) 또는 핑크(서브) 점선 상자가 글자·외곽선·그림자까지 감쌉니다. 상자는 캔버스 실측 뒤에 그리고, 격자는 미리보기 플레이트 위에 그립니다.',
