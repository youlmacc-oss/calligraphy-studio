      ...
      play: [
        {
          ...
          body: '중앙 툴바와 우측 패널의 [🎬 모션 GIF 스튜디오]를 누르면 독립 3단 스튜디오가 열리고, 현재 메인 캔버스가 소스로 들어갑니다. 5대 물리 프리셋(젤리 바운스·네온 브리딩·큐트 위글·시네마틱 글리치·소프트 플로팅)이 60fps 뷰포트에 실시간 반영됩니다. [🚀 초고화질 무한루프 GIF 다운로드]는 투명 GIF89a를 인코딩해 저장합니다.',
