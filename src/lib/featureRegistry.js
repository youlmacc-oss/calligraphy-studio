...
export const APP_FEATURES_REGISTRY = [
  ...
  feature({
    id: 'drag',
    name: '마우스 드래그 좌표 엔진',
    description: '캔버스 2D Transform 및 바운딩 박스 히트박스 연산 테스트',
  ...
  feature({
    id: 'stack',
    name: '레이어 Z-Index 스택',
    description: '앞/뒤 레이어 순서 변경 및 렌더링 오버레이 순서 일치 검증',
  ...
  feature({
    ...
    guideContent: {
      ...
      summary: [
        { title: '3단 레이아웃', body: '왼쪽↔캔버스 사이 세로선을 드래그하면 폭이 바뀌고, 더블클릭하면 360px로 돌아갑니다. 버튼 위에 마우스를 올리면 22px 돋보기 HUD가 뜹니다. 상단 1:1 / 16:9 / 9:16으로 미리보기 화면비를 바꿉니다.' },
      ...
      play: [
        {
          ...
          body: '왼쪽에서 👑 메인 또는 ✨ 서브 카드를 누르거나, 캔버스 위 글자를 한 번 클릭합니다. 선택되면 청록(메인) 또는 핑크(서브) 상자가 글자를 감쌉니다. 상자가 안 보이면 위치 잠금이 켜져 있는지 확인하세요.',
          params: ['커서가 grab이면 이동 가능', '🔒 위치 잠금 OFF'],
          tip: '여러 레이어가 겹치면 맨 앞(나중에 그린) 글자가 먼저 잡힙니다. 안 잡히면 왼쪽 카드를 눌러 선택을 확정하세요.',
        ...
        },
        {
          ...
          body: '상자 오른쪽 아래 작은 네모를 잡고 바깥으로 끌면 글자가 커지고, 안쪽으로 끌면 작아집니다. 메인 권장 크기 90~120px, 서브 32~48px입니다. 너무 키우면 가장자리에서 잘리므로 크롭 전에 여백을 남기세요.',
          params: ['메인 90~120px', '서브 32~48px', '낙관 28~90px'],
  ...
  feature({
    ...
    guideContent: {
      ...
      play: [
        {
          title: '그리는 순서 = 화면의 앞뒤',
          body: '배열 앞쪽(⬇️ 아래)이 배경에 가깝고, 맨 뒤 항목이 눈앞에 옵니다. 각 카드 상단의 [🔄 맨 뒤로] [⬇️ 한 단계 아래로] [⬆️ 한 단계 위로] [🔝 맨 앞으로]가 이 순서를 바꿉니다.',
          params: ['뒤 = 맨 뒤로', '앞 = 맨 앞으로'],
