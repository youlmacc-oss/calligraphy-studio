...
export const APP_FEATURES_REGISTRY = [
  ...
  feature({
    ...
    guideContent: {
      ...
      kicker: '첫 화면 기본은 龍 Dragon 풍정 + 훈민정음 언해 목각입니다. 다크 1:1 캔버스, 중앙 청록 십자 가이드, 격자 ON입니다.',
      visuals: [
      ...
      summary: [
        ...
        { title: '프리셋 원클릭', body: '첨부 화면의 금동색 3D 글자는 [🪵 전통 목각]에서 [훈민정음 언해 목각]을 고른 결과입니다. 캔버스는 [다크], 격자와 중앙 십자 가이드가 켜져 있습니다. 툴바 [기본 샘플]이나 이 장의 샘플 버튼으로 같은 룩을 다시 불러옵니다. 키치 스티커는 올인원 탭 카드에서 따로 고릅니다.' },
      ...
      play: [
        {
          ...
          body: '첫 실행 기본 샘플은 龍 Dragon 풍정 · 훈민정음 언해 목각 70px · 다크 1:1입니다. 캔버스 전체에 청록 가로·세로 십자가 항상 보이고, 선택 레이어는 점선 상자로 감쌉니다. 격자는 툴바 [격자/눈금]으로 켜고 끕니다.',
