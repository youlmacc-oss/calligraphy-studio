    ...
    guideContent: {
      ...
      play: [
        ...
        },
        {
          ...
          body: '폰트 선택창 상단에 TTF/OTF/WOFF를 올리면 FontFace로 즉시 등록됩니다. 우측에서 프로젝트 JSON 저장/불러오기, PNG 1x/2x/4x 배율, [⚡ 스타일 프롬프트 복사]로 지금 색·타이포 무드를 Grok/Midjourney에 붙여넣습니다. 캔버스 모서리 [투명/다크/라이트]는 미리보기만 바꾸고 투명 PNG는 유지됩니다.',
