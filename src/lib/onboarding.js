...
export const ONBOARD_STEPS = [
  {
    ...
    title: '🧩 이모티콘 30종 분할기',
    body: 'AI가 만든 스티커 시트를 올리면 360×360 PNG와 ZIP으로 한 번에 나눕니다. 카카오 이모티콘 스튜디오 규격에 맞춘 첫 단추입니다.',
  },
  {
    id: 'gif',
  ...
  },
  {
    ...
    title: '📊 하단 실시간 인포 바',
    body: '선택한 레이어의 글자 수, 폰트, 좌표, 프리셋과 캔버스 FPS/지연시간이 여기에 바로 반영됩니다. 작업 중 수치를 눈으로 확인하세요.',
  },
]
